        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div id="carousel-{{ $schedule->album->hashed_id }}" class="carousel slide" data-ride="carousel" data-interval="3000">
                                <!-- Indicators -->
                                <ol class="carousel-indicators">
                                    @foreach ($schedule->album->images as $image)
                                        @if ($loop->first)
                                        <li data-target="#carousel-{{ $schedule->album->hashed_id }}" data-slide-to="{{ $loop->index }}" class="active"></li>
                                        @else
                                        <li data-target="#carousel-{{ $schedule->album->hashed_id }}" data-slide-to="{{ $loop->index }}"></li>
                                        @endif
                                    @endforeach
                                </ol>
                                ...
                                <!-- Controls -->
                                <a class="left carousel-control" href="#carousel-{{ $schedule->album->hashed_id }}" role="button" data-slide="prev">
                                    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="right carousel-control" href="#carousel-{{ $schedule->album->hashed_id }}" role="button" data-slide="next">
